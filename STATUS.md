...
- `pnpm test:content-qa` validates required-tool declarations, regulatory-context links, disclaimer language, synthetic-data boundaries, dataset synthetic-only notes, and internal Markdown links; `make check` and CI include it.
...
- The release checklist requires manifest validation, dataset validation, fixture tests, content QA, `pnpm build`, `make check`, and a generated-artifact/git-status review.
