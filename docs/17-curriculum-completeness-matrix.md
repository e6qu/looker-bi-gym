...
| --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `00-orientation-and-stack.md`           | Self-contained orientation decision log with the quiz treated as separate verification.                                          | Expand later with a concise path map after remaining tutorial repairs stabilize.                                       |
...
| T041-TUT-06 | `06-performance-and-cost-lab.md`        | First pass implemented | Browser path is self-contained with source profiling, safe serving output, deterministic cost-signal simulation, daily operations control, and recovery paths; optional UI path still needs verification.                                                        |
| T041-TUT-07 | `07-governance-security-and-sharing.md` | First pass implemented | Browser path is self-contained with exact field classification, minimisation controls, governed source output, credential-mode comparison, sharing register, and recovery paths; optional UI path still needs verification.                                      |
| T041-TUT-08 | `08-observability-and-operations.md`    | First pass implemented | Browser path is self-contained with exact dependency register, freshness control, simulated job-byte evidence, reconciliation, incident triage, validation evidence, and recovery paths; optional UI path still needs verification.                              |
| T041-TUT-09 | `09-technical-bi-capstone.md`           | First pass implemented | Browser path is self-contained with exact artifact checklist, governed source, source controls, metric contracts, dashboard specs, governance/operations controls, rubric score, review workflow, and recovery paths; optional UI path still needs verification. |
