...
| T041-TUT-03 | `03-first-executive-dashboard.md`       | Next                   | Remove dependency on an assumed existing report; start from an explicit serving result or a verified prior artifact; add exact chart setup and expected states. |
| T041-TUT-02 | `02-build-a-bi-friendly-model.md`       | Planned                | Convert the conceptual model outline into fixture-backed SQL steps with expected outputs, grain contract, and fanout checks.                                    |
| T041-TUT-04 | `04-metrics-and-calculated-fields.md`   | Planned                | Add exact Looker Studio field formulas, aggregation settings, expected chart values, and recovery paths.                                                        |
| T041-TUT-05 | `05-blending-vs-upstream-joins.md`      | Planned                | Add deterministic upstream SQL results and an externally verified Looker Studio blend setup comparison.                                                         |
