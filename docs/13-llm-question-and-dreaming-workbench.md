...
collateral dataset. It currently builds a local context bundle from root
`facts/`, `sources/`, the challenge manifest, fixture SQL, fixture expected
answers, and dataset metadata.
